...
export default {
        ...
        /**
         * 转发
         * pages/goods/goodsDetailed.vue 的 onShareAppMessage 是这么写的，未登录则调到登录页
        ...
        methods: {
            ...
            generateShareUrl (shop_id) {
                if (shop_id && shop_id > 0) {
                    ...
                    this.shareHref = url + 'pagesA/store/store?is_share=true&shop_id=' + shop_id;
                    this.shareHref2 = '/pagesA/store/store?is_share=true&shop_id=' + shop_id;
                } else {
                    this.is_shop = false;
