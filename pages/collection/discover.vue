                    ...
                    <view class="li_right">
                        ...
                        <div class="li_right_bottom">
                            <div class="allgoods_li_priceBox" v-if="!is_grade">
                                ...
                                <!-- <p>{{ language.shoppingCart.vipPrice }}￥{{Number(items.vip_price).toFixed(2)}}</p> -->
                            </div>
                            <div class="allgoods_li_priceBox" v-else>
                                ...
                                <p style="color: #999999;text-decoration: line-through;">￥{{ Number(items.vip_yprice).toFixed(2) }}</p>
                            </div>
