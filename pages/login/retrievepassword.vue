<template>
    <div>
        ...
        <div class="head">
            <div class="left_img" @tap='_back'>
                <img :src="back1" mode=""></image>
            </div>
            <div class="center_p">
                {{ title }}
            </div>
        ...
        <div v-if='!pass'>
            <div class='login' style='position: relative;'>
                ...
                <div class='button buttons' :class="old_password.length > 5 && new_password.length > 5 ?'active':''" @tap="_next_three">{{language.retrievepassword.saveBtn}}</div>
            </div>
            ...
            _next_one () {
                ...
                this.$req.post({data}).then(res => {
                    if (res.code == 200) {
                        ...
                        this.changeStep = false
                        if(this.zhanghao.length > 0 && this.phone_code.length == 6){
                            this.changeStep = true
                        }
                    } else {
                        uni.showToast({
