                            ...
                            <div class="yh-pay-s">
                                ...
                                <div class="yh-pay_div">
                                    <p class="yh-pay_div-p">
                                        ...
                                        <text style="color: #999999;">（{{language.choosePay.yue}}￥{{ user_money.toFixed(2) }}）</text>
                                    </p>
                                </div>
                            </div>
...
<script>
    export default {
        ...
        mounted() {
            let urlInfo = parent.window.location.href
            this.falg = urlInfo.includes('order_payment')
