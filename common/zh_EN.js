export default {
    ...
    showModal: {
        ...
        delPro: 'Whether to delete this item',
        delOrder: 'Whether to close this order'
    },
    toasts: {
        copyText: {
        ...
        distribution_center: {
            ...
            lkt_submit: ["Withdrawal application successful", "Get the captcha first",
                "The input of mobile phone number is inconsistent", "Please fill in the complete information", "Please bind the bank card"
            ],
        ...
        login: {
            ...
            no_config:'No SMS information set'
        },
        uploadPro: {
    ...
    chooseAddress: {
        ...
        autoAddAddress: "get wechat address",
    },
    choosePay: {
        choosePay: "Please select the mode of payment",
    ...
    shoppingCart: {
        rgoods:"Physical Goods",
        vgoods:"Virtual Goods",
        title: "Shopping cart",
        ...
        noStockDisc: "Out of stock, please select another specification",
        failureGood: "failure goods",
        clearFailure: "Empty failure goods",
        failure: "failure"
    },
    myScore: {
        title: "My points",
    ...
    myWallet: {
        ...
        qxtj: 'Please add your phone number first',
    },
    bankCard: {
        title: 'Bank Card Management',
        tjyhk: 'Add a bank card'
    },
    recharge: {
        title: "Top up",
    ...
    putForward: {
        ...
        moneyTips: ["Withdrawal should be greater than", "yuan, please enter again!",
            ...
            "The withdrawal amount cannot be greater than the maximum withdrawal amount, please re-enter!"
        ],
    ...
    bankCardAdd: {
        qtxyhxx: 'Fill in the withdrawal card information',
        qrtj: 'Confirm to add',
        qrbj: 'Confirm to edit',
        swmr: 'Set to the default',
        tj: 'Add a bank card',
        bj: 'Edit bank card'
    },
    bankCardDetail: {
        jcbd: 'Remove the binding',
        bj: 'edit',
        qrjb: 'Confirm to unbind this bank card',
    },
    ...
    afterSale: {
        ...
        preSale_placeholder:'Search for pre-sale items',
        search_btn: "search",
        ...
        phone_allright: "Please fill in the correct telephone number",
        submit: "submit",
        cancel: "cancel",
        confirm: "confirm",
    ...
    bargain: {
        ...
        lowest: "Haggling success,order not paid",
        ...
        no_bargainText2:'No bargain goods',
        no_bargainBtn: "Visit",
        prompt: "hint",
        promptContent: [
    ...
    bargainIng: {
        ...
        success: "Congratulations, successful bargaining! Please pay in time!",
        friendShare: "Share your friend's bargain",
        share: "Invite friends to help",
        toPay: "To pay",
        obligation: "obligation",
    ...
    bidding_my: {
        ...
        ongoing: "ongoing",
        finished: "finished",
        jujieshu: 'From the end of the',
        obligation: "obligation",
        success: 'auction success',
        fail: 'auction fail',
        auction: 'auction',
        done: "done",
        tishi1: 'Unsold goods will be rejected within 24 hours of successful bidding',
        tishi2: 'Failed to meet the number of bidders, the goods have been rejected',
        tishi3: 'Failed to pay in time, the goods have been rejected',
        end: 'end',
    ...
    // 分销中心
    distribution_center: {
        yjph: 'commission list',
        tgdd: 'promote the order',
        title: "The agency",
        referrer: "Referrer: ",
    ...
    distribution_flow: {
        ...
        wff: 'Not to issue',
        yff: 'issued',
        ddly: 'Source of the order',
        ddje: 'The order amount',
        ddbh: 'The order no.',
    ...
    distribution_form: {
        ...
        bankcard: 'Bank card',
        qcybr: 'Please bind the cardholder\'s own bank card',
        xzdz: 'Select the bank card to your account',
        syxk: 'Use the new card to withdraw money'
    },
    // 提现结果
    distribution_result: {
        title: "withdrawal",
    ...
    activities_set: {
        ...
        totalInventory: "Current total inventory: ",
        success: "success",
        error1: "Active inventory should not be greater than total inventory"
    },
    // 库存管理
    addStock: {
        title: "Inventory management",
        title1:'Edit offline stores',
        load: "Loading",
        inventory: "surplus",
        warning: "warning",
        addInventory: "add",
    ...
    applyStore: {
        ...
        addressFail: "The area can not be empty",
    ...
    choose_shopping: {
        ...
        productNameTips: "Please fill in the name of the item",
        kucun: "Inventory: ",
        nopro: "There are no products available for the time being",
        checkAll: "check all",
        selected: "selected",
        items: "items",
        add: "add",
    ...
    choosePro: {
        ...
        zwsp:'There are currently no products to choose from',
        zwkxsp:'No selected products',
    },
    // 店铺优惠券
    storeCoupon: {
        title: "coupons",
    ...
    freight_add: {
        ...
        name: "template name",
        name_placeholder:'Please enter the template name',
        ...
        Tips: 'hint',
        TipsText: 'Whether to delete this template'
    },
    // 添加运费模板——添加规则模板
    freight_rules: {
        title: "Add Style",
    ...
    myFinance: {
        ...
        tabList: ["after the detail", "integral", "withdrawal"],
    ...
    storeMyOrder: {
        title: "my order",
        searchPlace: 'Please enter your order number',
    ...
    myStore: {
        ...
        reason: "reason: ",
        toApply: "To apply",
        mch_code: 'Cashier pay',
        bzjgl:'Margin management',
        bzj_title:"Deposit",
        bzj_content: "You have not paid the deposit, and cannot proceed with the operation to pay immediately",
    },
    addAddress: {
    ...
    goods: {
        goods: {
            ...
            add_success: 'Added successfully, waiting for you in shopping cart~',
            start_pre_sale:'start pre-sale',
            balancePay:'balance payment',
            got_it:'got it',
            instructions:'Pre sale instructions',
            deposit:'deposit',
            PaymentDeposit:'Payment of deposit',
            pre_sale_process:'process',
            presale:'presale',
        },
        goodsDet: {
            ...
            hold_picture: 'Long press to save the picture',
            ...
            stock2: 'Insufficient inventory, unable to participate in bargaining！',
            ...
            number: 'number',
            stock: 'stock',
            share_make: 'share make',
            zwtjsp:'There are no recommended products in this shop~',
            zwsp:'There are no products in this shop~',
            zwspfl:'There is no product category in this shop~',
        }
    },
    index: {
        In: 'In seconds',
    ...
    home: {
        goPre_sale:'Go to my pre-sale',
        handle:'Please deal with it quickly!',
        ...
        share_make: 'The highest earning'
    },
    order: {
        myorder: {
            title: 'My order',
            pre_title:'My pre-sale',
        ...
        order: {
            ...
            logistics: ['Logistics information', 'Logistics information: the logistics has been split',
                'Send out packages, click "view logistics" to view details', 'The merchant has delivered the goods, please pay attention to the logistics information in time'
            ],
            button: ['refund', 'after sale', 'evaluation', 'comments', 'after finish'],
            gift: 'gift',
            ...
            Balance_payment: 'Balance payment required',
            order_number: 'order number',
            ...
            goodHasDel: 'The item has been deleted'
        }
    },
    pay: {
        orderDetailsr: {
            ...
            reduction1: 'distributor discount reduction',
            Discount: [
    ...
    expressageb: {
        ...
        logistics: 'Buyers return logistics',
        logistics1: 'Merchant return logistics',
        Loading: 'Data load failed！'
    },
    chooseArea: {
        title: 'Select region',
    ...
    mchList: {
        ...
        nodata: 'There is no such product yet~',
    },
    proList: {
    ...
    seckill: {
        ...
        seckill_my: {
            ...
            status: ['To payment', 'To delivered', 'To received', 'To evaluated', 'Transaction closure','Successful trade'],
            common: 'common',
            piece: 'piece',
            total: 'total',
    ...
    vipClub: {
        ...
        Member_sharing1: 'Friends invite you to join the guest Twitter member, enjoy multiple benefits...',
        upgrade: 'upgrade',
        renew: 'renew ',
        Valid: 'Valid until',
    ...
    store: {
        ...
        fracture: 'fracture',
        receive: 'receive',
        changeTab: ['recommend', 'General merchandise','Pre sale goods','classification'],
    ...
    uploadPro: {
        ...
        Product: 'title',
        Product_placeholder: [
            'Please enter the product title', 'Please enter the product title, 1-14 characters',
        ...
        keyword: 'keyword',
        keywordPH: 'Please enter the commodity keyword',
        weight: 'weight',
        code: 'Bar code',
        category: 'category',
        brand: 'brand',
        ...
        price: ['Cost price', 'original price', 'price', 'stock', 'Inventory warning', 'Company', 'set attributes','virtual sales'],
        inventory: 'stock',
        price_placeholder: [
            ...
            'Please set virtual sales for the item'
        ],
        ...
        classToast: 'Please select the above categories'
    },
    tixian: {
    ...
    setAttr: {
        ...
        price: ['Cost price', 'original price', 'price', 'stock', 'upload'],
        add: 'add to',
        deletes: 'delete',
        complete: 'complete',
    ...
    returnDetail: {
        ...
        appliTime: 'apply time:',
        returnType: 'Return type:',
        returnList: ['refunds','refund','exchange'],
        refund: 'amount:',
        reasons: 'reasons:',
        ...
        refusalReasons: 'Refusal reason:',
        refundAmount: 'refund:',
        returnLogistics: 'Return logistics:',
        returnTime: 'Return time:',
        returnLogistics1: 'Exchange logistics:',
        returnTime1: 'Exchange time：',
        reject: 'reject',
        pass: 'pass',
        sendTips: ['Sure the goods sent back are ok,','Send goods back to the user?'],
        cancel: 'cancel',
        confirm: 'confirm',
        toSend: 'To send',
        passTips: ["Sure approve user's application,", 'Ask the user to mail it back?'],
        jujueTips: 'Fill in the reasons for refusal',
        jujuePlace: 'Enter the reason for refusal',
        refuldTitle: 'Fill in the amount of refund',
        refuldPlace: 'Enter the amount of refund',
        moneyTips: ['Refund',', The money will be returned the same way'],
        type_list: ["To audit", "refund", "Refund success", "Refund failure", "In exchange", "Exchange success", "Exchange failure"],
        refusalReason: 'Please enter reason for refusal'
    },
    distribution_order: {
        ddsl: 'order quantity',
        ...
        ddbh: 'The order no.',
        gmsj: 'Buy time',
        search: 'Please enter user nickname/product name'
    },
    fxRanking: {
        jr: 'Today',
        bz: 'week',
    ...
    fxProduct: {
        search_placeholder: 'Please enter the product name',
        share_make: 'The highest earning'
    },
    fxPackageProduct: {
        search_placeholder: 'Please enter the product name',
    ...
    choose_freight: {
        title: 'Goods set',
        freight: 'freight',
        freightPH: 'Please select the shipping template'
    }
}
