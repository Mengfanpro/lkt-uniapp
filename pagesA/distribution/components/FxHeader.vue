<template>
    <div style="display: flex" :style="{height: BoxHeight}">
        <!-- #ifndef MP-ALIPAY -->
        <div class='head' :class="{'head_w':ishead_w == '1', 'border':border == true}" style="background: none">
            <div  :style="{height: halfWidth}" ></div>
            <div class='header'>
                ...
                <div class="header-right" :style="{'margin-top':halfWidth}" v-if="rightText" @click="$emit('right-click')">
                    <div class="content">
